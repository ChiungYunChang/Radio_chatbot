...
#         #         thumbnail_image_url='https://upl
#         #     alt_text='Buttons template',oad.cc/i1/2020/01/02/psRVCD.jpg',
#         #         title='Function',
#         #         text='Please select',
#         #         actions=[
...
#         #             # URITemplateAction
#         #             URITemplateAction(
#         #                 label ='Central Weather Bureau',
#         #                 uri = 'https://www.cwb.gov.tw/V8/C/W/W50_index.html'
#         #             )
#         #         ]
#         #     )
#         # )
#         message = MakeWeather("安平")
